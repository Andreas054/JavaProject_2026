...
public class AuthorController {
    ...
    @GetMapping
    @Operation(summary = "Get all authors", description = "Returns a list of all authors in the database")
    ...
    @GetMapping("/search")
    @Operation(summary = "Search for authors by name", description = "Returns a list of authors with matching names")
